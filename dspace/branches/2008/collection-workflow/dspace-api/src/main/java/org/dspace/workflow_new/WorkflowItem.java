...
//    private ArrayList<StepRecord> activeSteps;
 ...
 //       activeSteps = new ArrayList<StepRecord>();
    ...
    /*
     * Initialize the workflow for this item
     */
    private void initialize() throws WorkflowConfigurationException, SQLException {
        WorkflowFactory.getWorkflow(ourContext,collection.getID());
    }
