 ...
 */
public abstract class Action extends WorkflowPart {
    ...
    public abstract void configure(Node node) throws WorkflowConfigurationException;

    public String getNodeId(Node node){
        return node.getAttributes().getNamedItem("id").getFirstChild().getNodeValue();
    }

    public abstract Action execute(Context c, WorkflowItem wi, EPerson e, HttpServletRequest request) throws SQLException, IOException, MessagingException, WorkflowException, AuthorizeException, WorkflowConfigurationException;
    ...
    public void endActionAndClaimNext(WorkflowPart next, Context c, EPerson e, WorkflowItem wi) throws SQLException, IOException, MessagingException, AuthorizeException, WorkflowConfigurationException {
